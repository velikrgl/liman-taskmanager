...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link" onclick="ListManager()" href="#List_Files_Manager" data-toggle="tab">
            <i class="fas fa-tasks"></i> {{ __("Dosya Listeleme") }}
...
<div class="tab-content">
    ...
    <div id="List_Files_Manager" class="tab-pane">
        @include('listfiles.main')
    </div>
